## Update:
For running the code in Python 3.8 and Tensorflow 2.4.1, please refer the branch [**py38_tf24**](https://github.com/jianlianggao/pointer-generator/tree/py38_tf24).
